...
The code requires a number of inputs to run. A suitable dataset is included in the repository, and code to set up the spline design matrices needed is also in a separate file in the repository.
